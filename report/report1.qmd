---
title: "MEK9470 Mandarory Exercise 1"
...
Here we solve the backwards facing step problem for $Re = 200$. We use a grid where the inlet has height H = 1, and the width of the channel is 2. The length of the inlet is 5, and the lenght of the channel is 15. 
...
We see that the flow is separatates from the back step and forms a recirculation region. 
...
We see that the case with contant inlet velocity has a slightly shorter reattachment length (approximately 7.8) than the case with parabolic inlet velocity (approximately 7.9).
...
In summary, the icoFoam uses the PISO alorithm that can be summarized as follows (from [@pisoalg], line numbers in the implementation file are added):
...
::::: grid
::: g-col-6
![](figures/ldc/Re100_m1_streamfunction_crop.png) Re = 100, upwind
:::

::: g-col-6
![](figures/ldc/Re100_m2_streamfunction_crop.png) Re = 100, QUICK
:::
:::::
...
:::::: grid
::: g-col-4
![](figures/ldc/Re1000_m1_streamfunction_crop.png) Re = 1000, upwind
:::

::: g-col-4
![](figures/ldc/Re1000_m2_streamfunction_crop.png) Re = 1000, QUICK
:::

::: g-col-4
![](figures/ldc/Re1000_linear_streamfunction_crop.png) Re = 1000, central differencing
:::
::::::
...
![Streamfunction for Re = 250. The center of the main vortex is marked with a dot.](figures/ldc/Re250_linear_stream_with_min_crop.png){#fig-LDC-Re250}
...
## Code
The code for this exercise is available at [github.com/kristianholme/MEK9470-mandatory-exercise-1](https://github.com/kristianholme/MEK9470).